...
const LoansPage = () => {
  ...
  const calculatorSection = showCalculator && (
      ...
      <div className={styles.calculatorContent}>
        ...
        <div className={styles.calculatorResults}>
          <div className={styles.resultItem}>
            ...
            <span className={styles.resultValue}>${calculateLoan().monthlyPayment}</span>
          </div>
          <div className={styles.resultItem}>
            <span className={styles.resultLabel}>Total Payment:</span>
            <span className={styles.resultValue}>${calculateLoan().totalPayment}</span>
          </div>
          <div className={styles.resultItem}>
            <span className={styles.resultLabel}>Total Interest:</span>
            <span className={styles.resultValue}>${calculateLoan().totalInterest}</span>
          </div>
        </div>
      </div>
    </Card>
  ...
  const filtersSection = showFilters && (
  ...
  const applicationFormSection = showApplicationForm && (
  ...
  const loansListSection = (
    <div className={styles.loansList}>
      {loans.map(loanCard)}
    </div>
  );

  const loansContainerSection = (
    <div className={styles.loansContainer}>
      {loans.length === 0 ? emptyStateSection : loansListSection}
    </div>
  );
